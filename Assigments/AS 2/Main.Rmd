...
```{r instrument, eval=FALSE, echo=TRUE}
...
6.  Now let's pay attention to potential issues of weak instruments. As
...
7.  Following the Borusyak and Hull (2021) working paper (BH), we can
...
8.  Discuss your findings and compare estimates from different
    estimators.

9.  Reflect on this assignment. What did you find most challenging? What
