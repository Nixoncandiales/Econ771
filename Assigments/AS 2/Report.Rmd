...
```{r, include=FALSE}
load(here("Output","Rdata","Workspace.Rdata"))
```
...
```{r Q1, include=TRUE, echo=TRUE, results='asis'}
...
```{r Q3, eval=TRUE,results='asis', include=TRUE, comment=NA, warning=FALSE, message=FALSE}
modelsummary(mod.fe, output = "latex")
```
