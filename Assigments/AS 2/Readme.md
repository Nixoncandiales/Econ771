...
```
    ...
    ## Rows: 2666873 Columns: 10
    ## ── Column specification ────────────────────────────────────────────────────────
    ## Delimiter: ","
    ## dbl (10): Year, npi, int, group1, group2, line_srvc_cnt, bene_unique_cnt, av...
    ## 
...
```
    ...
    ##   <chr>        <dbl>      <dbl> <dbl>        <dbl>
    ## 1 Spending 11230233. 103940660.  0.93 25120624216.
    ## 2 Claims       2884.     13597.  4        5750425 
    ## 3 Patients     1061.      1978. 11         724713
...
```
    ...
    ## Loading required package: robomit
...
```
    ...
    ##   <chr>                      <dbl>
    ## 1 delta*                    1.30  
    ## 2 Uncontrolled Coefficient -0.755 
    ## 3 Controlled Coefficient   -0.472 
    ## 4 Uncontrolled R-square     0.0410
    ## 5 Controlled R-square       0.252 
    ## 6 Max R-square              0.5   
    ## 7 beta hat                  0     
    ## # A tibble: 7 × 2
    ##   Name                       Value
