...
\begin{figure}
\subfloat[Sample 2014\label{fig:Fig-3-1}]{\includegraphics[width=.49\linewidth]{Report_files/figure-latex/Fig-3-1} }\subfloat[Full Sample\label{fig:Fig-3-2}]{\includegraphics[width=.49\linewidth]{Report_files/figure-latex/Fig-3-2} }\caption{Event Study}\label{fig:Fig-3}
\end{figure}
\newpage
...
\begin{figure}
\subfloat[ATT by Cohorts\label{fig:Fig-5-1}]{\includegraphics[width=.49\linewidth]{Report_files/figure-latex/Fig-5-1} }\subfloat[Event Study\label{fig:Fig-5-2}]{\includegraphics[width=.49\linewidth]{Report_files/figure-latex/Fig-5-2} }\caption{CS Specification}\label{fig:Fig-5}
\end{figure}
...
\begin{figure}
\subfloat[Smooth\label{fig:Fig-6-1}]{\includegraphics[width=.49\linewidth]{Report_files/figure-latex/Fig-6-1} }\subfloat[Sensitivity\label{fig:Fig-6-2}]{\includegraphics[width=.49\linewidth]{Report_files/figure-latex/Fig-6-2} }\caption{RR Specification}\label{fig:Fig-6}
\end{figure}
