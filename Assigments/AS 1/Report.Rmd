...
```{r Fig-3, include=TRUE, echo=FALSE, cache=FALSE, results=FALSE, warning=FALSE,  comment=FALSE, message= FALSE,  fig.cap = "Event Study", fig.subcap=c('Sample 2014', 'Full Sample'), out.width='.49\\linewidth', fig.asp=1, fig.ncol = 2 }
...
```{r Tab-5, include=TRUE, echo=FALSE, warning=FALSE, comment=NA, message=FALSE, label="Tab-5", results='asis'}
modelsummary(mod.sa,
                title = "Event Estudy SA Specification",
                style = "aer",
                table.placement = "H",
                column.labels = c("M1", "M2", "M3", "M4"),
                model.numbers = TRUE,
...
```{r Fig-4, include=TRUE, echo=FALSE, fig.cap = "Effect of Medicaid Eaxpansion on Uncompensated - SA Specification", warning=FALSE,comment=NA, message=FALSE, label="Fig-4"}
...
```{r Fig-5, include=TRUE, echo=FALSE, cache=FALSE, results=FALSE, warning=FALSE,  comment=FALSE, message= FALSE,  fig.cap = "CS Specification", fig.subcap=c('ATT by Cohorts', 'Event Study'), out.width='.49\\linewidth', fig.asp=1, fig.ncol = 2 }
ggdid(mod.cs)
...
modelsummary(mod.cs.event,
                title = "Event Estudy CS Specification",
                style = "aer",
                table.placement = "H",
                column.labels = c("M1", "M2", "M3", "M4"),
                model.numbers = TRUE,
...
```{r Fig-6, include=TRUE, echo=FALSE, cache=FALSE, results=FALSE, warning=FALSE,  comment=FALSE, message= FALSE,  fig.cap = "RR Specification", fig.subcap=c('Smooth', 'Sensitivity'), out.width='.49\\linewidth', fig.asp=1, fig.ncol = 2 }
cs_HDiD_smooth
cs_HDiD_relmag
```
...
I can get two main takeaways from this assignment. The importance of developing a transparent and reproducible workflow allowed me to make the changes easily) and improve my coding skills to avoid code repetition and improve accuracy and efficiency.