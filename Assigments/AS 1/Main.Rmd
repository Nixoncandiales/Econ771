...
pacman::p_load(tidyverse, ggplot2, dplyr, lubridate, reticulate, haven, descriptr, HonestDiD, did, fixest, RColorBrewer, patchwork, ggthemes, DT, plotly, here, crosswalkr, plm, lfe, stargazer, modelsummary)
...
``` {r, event-study}
ins.plot.dat <- df %>% filter(expand_year==2014 | is.na(expand_year), !is.na(expand_ever)) %>%
