...
pacman::p_load(tidyverse, ggplot2, dplyr, lubridate, reticulate, haven, descriptr, HonestDiD, did, fixest, RColorBrewer, patchwork, ggthemes, DT, plotly, here, crosswalkr, plm, lfe, stargazer, modelsummary, fixest, DRDID, ggthemes, patchwork)
...
if (!exists("data_pos")) data_pos <- read_stata(here("Output", "POS", "pos_lastyear.v12.dta"))
...
```{r , tidy=TRUE, echo=TRUE, cache=TRUE, comment=NA, warning=FALSE}
...
``` {r event-study, tidy=TRUE, echo=TRUE, cache=TRUE, comment=NA, warning=FALSE}
